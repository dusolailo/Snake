...
public class BoardDrawing extends JPanel {
        ...
        for (Rectangle cell : cells) {
            ...
            for (int pl = 0; pl < bs.maxPlayers; pl++) {
                if (bs.players.get(pl).getPosition() == cellnos[i]) {
                    ChangetoPlayer(g2d, pl, cell, cellWidth, cellHeight);
                }
            }
     ...
     * @param cellHeight
     */
    private void ChangetoPlayer(Graphics2D g2d, int pl, Rectangle cell, int cellWidth, int cellHeight) {
